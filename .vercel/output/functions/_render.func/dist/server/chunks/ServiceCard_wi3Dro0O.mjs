...
import { S as ServiceOptions } from './ServiceOptions_Dmgq1fL7.mjs';
...
function EventOptions({ eventId, authorId, currentUserId, currentUserRole, slug }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative z-20", ref: menuRef, children: [
    ...
    isOpen && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 mt-2 w-48 bg-(--bg-card) rounded-md shadow-lg py-1 border border-(--border-color) overflow-hidden animate-fade-in", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: (e) => {
      ...
      canEdit && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("div", { className: "h-px bg-(--border-color) my-1" }),
        /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: (e) => {
...
const EventCard = ({ event, currentUser }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-white border border-(--border-color) overflow-hidden hover:border-primary-500/50 transition-all group flex flex-col h-full relative shadow-sm hover:shadow-md", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute top-3 right-3 z-30", children: /* @__PURE__ */ jsx(
      EventOptions,
      {
        eventId: event.id,
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative h-48 w-full bg-gray-100 border-b border-gray-100 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "absolute top-3 left-3 bg-white/90 backdrop-blur-md border border-(--border-color) px-3 py-1 text-xs font-bold text-(--text-main) shadow-sm", children: "Event" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "p-5 flex flex-col grow", children: [
      ...
      /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-(--text-main) mb-2 line-clamp-2 group-hover:text-primary-600 transition-colors", children: event.title }),
...
const ServiceCard = ({ service, currentUser }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex-shrink-0 w-full group relative block bg-[var(--bg-card)] overflow-hidden border border-[var(--border-color)] hover:border-primary-500/50 transition-all scroll-snap-align-start h-full flex flex-col", children: [
      ...
      "a",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "relative h-40 w-full overflow-hidden bg-[var(--bg-surface)]", children: [
            ...
            service.price && /* @__PURE__ */ jsxs("div", { className: "absolute bottom-2 right-2 bg-black/70 text-white text-xs px-2 py-1 backdrop-blur-sm border border-white/10", children: [
              "$",
              service.price
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "p-4 flex flex-col flex-grow", children: [
            ...
            service.organizer_company && /* @__PURE__ */ jsx("div", { className: "mt-auto pt-2 flex items-center gap-2", children: /* @__PURE__ */ jsx("span", { className: "text-[10px] uppercase font-bold text-[var(--text-secondary)] bg-[var(--bg-surface)] border border-[var(--border-color)] px-2 py-0.5 truncate max-w-full", children: service.organizer_company }) })
          ] })
        ]
      }
    )
