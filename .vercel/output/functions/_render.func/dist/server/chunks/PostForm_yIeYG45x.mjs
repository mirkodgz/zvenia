...
function PostForm({ currentUser, initialData }) {
  ...
  return /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6 max-w-3xl mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("label", { htmlFor: "topic_id", className: "block text-sm font-medium text-(--text-secondary) mb-2", children: "Topic / Category" }),
      /* @__PURE__ */ jsxs(
        "select",
        {
          id: "topic_id",
      ...
      /* @__PURE__ */ jsx("p", { className: "text-xs text-(--text-secondary) mt-1", children: "Select the most relevant mining sector for your post." })
    ] }),
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("label", { htmlFor: "title", className: "block text-sm font-medium text-(--text-secondary) mb-2", children: "Title" }),
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("label", { htmlFor: "slug", className: "block text-sm font-medium text-(--text-secondary) mb-2", children: "Slug (URL)" }),
      /* @__PURE__ */ jsxs("div", { className: "flex rounded-md shadow-sm", children: [
        /* @__PURE__ */ jsx("span", { className: "inline-flex items-center px-3 rounded-l-md border border-r-0 border-(--border-color) bg-(--bg-surface-hover) text-(--text-secondary) sm:text-sm", children: "zvenia.com/post/" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "text",
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-(--text-main) mb-3", children: "What would you like to share? ( Optional )" }),
      ...
      /* @__PURE__ */ jsx("div", { className: "border-2 border-dashed border-(--border-color) rounded-lg p-6 text-center hover:border-primary-500/50 transition-colors bg-(--bg-body) min-h-[200px] flex flex-col justify-center", children: activeMediaType === "youtube" ? /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md mx-auto", children: [
        /* @__PURE__ */ jsx("label", { className: "block text-left text-sm text-(--text-secondary) mb-1", children: "YouTube Video URL" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "url",
        ...
        isUploading ? /* @__PURE__ */ jsxs("div", { className: "text-(--text-secondary) flex flex-col items-center", children: [
          ...
          formData.metadata?.video_url && activeMediaType === "video" && /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-md mx-auto bg-black rounded-lg overflow-hidden border border-(--border-color)", children: [
          ...
          formData.document_url && activeMediaType === "pdf" && /* @__PURE__ */ jsxs("div", { className: "relative p-4 bg-(--bg-surface) rounded-lg border border-(--border-color) flex items-center justify-between max-w-md mx-auto w-full", children: [
          ...
          activeMediaType === "image" && (formData.featured_image_url || formData.metadata?.gallery?.length > 0) && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-2 w-full", children: [
            ...
            formData.metadata?.gallery?.map((img, idx) => /* @__PURE__ */ jsxs("div", { className: "relative group aspect-square rounded-lg overflow-hidden border border-(--border-color)", children: [
          ...
          !formData.metadata?.video_url && !formData.document_url && activeMediaType !== "image" || activeMediaType === "image" ? /* @__PURE__ */ jsxs("div", { className: `mt-4 ${activeMediaType === "image" && formData.featured_image_url ? "inline-block w-24 h-24 align-top ml-2" : ""}`, children: [
            ...
            /* @__PURE__ */ jsx(
              "label",
              {
                ...
                children: activeMediaType === "image" && formData.featured_image_url ? /* @__PURE__ */ jsx("span", { className: "text-2xl text-(--text-secondary)", children: "+" }) : /* @__PURE__ */ jsx("span", { children: activeMediaType === "image" && !formData.featured_image_url ? "Select Images" : activeMediaType === "video" ? "Select Video" : "Select PDF" })
              }
            )
          ] }) : null
        ] })
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("label", { htmlFor: "source", className: "block text-sm font-medium text-(--text-secondary) mb-2", children: "Source / Reference (URL or Text)" }),
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("label", { htmlFor: "content", className: "block text-sm font-medium text-(--text-secondary) mb-2", children: "Content" }),
      /* @__PURE__ */ jsx(
        "textarea",
        {
          name: "content",
    ...
    /* @__PURE__ */ jsxs("div", { className: "pt-4 border-t border-(--border-color) flex justify-end", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
