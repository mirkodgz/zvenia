...
const DropdownMenuContent = reactExports.forwardRef(({ className, sideOffset = 4, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuPrimitive.Portal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function HeaderUserDropdown({ user, profile }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { open: isOpen, onOpenChange: setIsOpen, modal: false, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Avatar, { className: "h-8 w-8 cursor-pointer", style: { backgroundColor: "#00c44b" }, children: [
                avatarUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarImage, { src: avatarUrl, alt: displayName }) : null,
                /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "text-white font-bold", style: { backgroundColor: "#00c44b" }, children: initials })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden xl:block", children: firstName || email?.split("@")[0] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          DropdownMenuContent,
          {
            ...
            onMouseLeave: handleMouseLeave,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuLabel, { className: "flex items-center gap-4 px-4 py-3 font-normal border-b border-gray-200", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Avatar, { className: "size-10", style: { backgroundColor: "#00c44b" }, children: [
                    avatarUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarImage, { src: avatarUrl, alt: displayName }) : null,
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "text-white font-bold", style: { backgroundColor: "#00c44b" }, children: initials })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-0 bottom-0 block size-2.5 rounded-full bg-green-600 ring-2 ring-white" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col items-start", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-dark text-base font-semibold", children: displayName }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-500 text-sm", children: email })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `px-4 py-2 border-b border-gray-200 ${roleColorClass}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheckIcon, { className: "h-4 w-4" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-wide", children: userRole })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, { className: "bg-gray-200" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuGroup, { children: [
                isAdministrator && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  DropdownMenuItem,
                  {
                    className: "px-4 py-2.5 text-base cursor-pointer",
                    onClick: () => window.location.href = "/admin",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutDashboardIcon, { className: "text-yellow-500 size-5 mr-3" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-500 font-bold", children: "Admin" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  DropdownMenuItem,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "text-dark size-5 mr-3" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-dark font-semibold", children: "Z-NETWORK" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  DropdownMenuItem,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Mic, { className: "text-dark size-5 mr-3" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-dark font-semibold", children: "Z-TALKS" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  DropdownMenuItem,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(UserIcon, { className: "text-dark size-5 mr-3" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-dark font-semibold", children: "User Area" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  DropdownMenuItem,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(UserIcon, { className: "text-dark size-5 mr-3" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-dark", children: "Your Profile" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  DropdownMenuItem,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsIcon, { className: "text-dark size-5 mr-3" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-dark", children: "Settings" })
                    ]
                  }
                )
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                DropdownMenuItem,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(LogOutIcon, { className: "size-5 mr-3" }),
...
function HeaderNotifications({ currentUserId, sessionAccessToken }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "relative text-gray-300 hover:text-white transition-colors focus:outline-none mr-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "w-6 h-6" }),
      unreadCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-red-500 text-[10px] font-bold text-white ring-2 ring-primary-500", children: unreadCount > 9 ? "9+" : unreadCount })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-80 bg-white border border-gray-200 shadow-lg mt-2 max-h-[80vh] overflow-y-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuLabel, { className: "font-semibold text-gray-900 border-b border-gray-100 pb-2 flex justify-between items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-1", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-center text-gray-500 text-sm", children: "Loading..." }) : notifications.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-center text-gray-500 text-sm", children: "No notifications" }) : notifications.map((notification, index) => {
        let Icon = Bell;
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            DropdownMenuItem,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 w-full", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mt-1 ${iconColor}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-4 h-4" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between w-full", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-medium text-sm ${!notification.is_read ? "text-gray-900" : "text-gray-700"}`, children: notification.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-gray-400 whitespace-nowrap ml-2", children: new Date(notification.created_at).toLocaleDateString() })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-500 line-clamp-2 mt-0.5", children: notification.message })
                ] })
              ] })
            }
          ),
          index < notifications.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, { className: "bg-gray-100" })
        ] }, notification.id);
      }) })
    ] })
  ] });
