import { e as createComponent, f as createAstro, m as maybeRenderHead, h as addAttribute, k as renderComponent, r as renderTemplate, p as Fragment } from '../chunks/astro/server_0Ysjtq05.mjs';
import 'piccolore';
...
function CreateContentModal({ currentUser, userInitials, activeFeed = "post" }) {
  ...
  const ALL_TABS = [
    {
      id: "post",
      label: "Posts",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", className: "w-4 h-4", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[var(--bg-surface)] border border-[var(--border-color)] p-4 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-[var(--bg-surface-hover)] flex-shrink-0 flex items-center justify-center border border-[var(--border-color)] group-hover:border-primary-500/50 transition-colors text-[var(--text-main)] font-bold", children: userInitials }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-[var(--bg-body)] border border-[var(--border-color)] px-6 py-3 text-sm text-[var(--text-secondary)] group-hover:border-primary-500/50 group-hover:text-[var(--text-main)] transition-all flex items-center shadow-inner", children: "Start a post, share a mining update..." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between items-center mt-4 pt-3 pl-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 sm:gap-4 overflow-x-auto no-scrollbar", children: ALL_TABS.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 border-b border-[var(--border-color)] bg-[var(--bg-surface)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-[var(--text-main)]", children: editId ? "Edit Content" : "Create Content" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-[var(--border-color)] bg-[var(--bg-surface)] px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex -mb-px space-x-8", "aria-label": "Tabs", children: tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-y-auto p-6 md:p-8 custom-scrollbar bg-[var(--bg-body)] flex-1", children: [
                activeTab === "post" && /* @__PURE__ */ jsxRuntimeExports.jsx(PostForm, { currentUser, initialData: { editId: editId || void 0 } }),
