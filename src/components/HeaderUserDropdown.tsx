      ...
      >
        ...
        <DropdownMenuLabel className="flex items-center gap-4 px-4 py-3 font-normal border-b border-gray-200">
          ...
          <div className="flex flex-1 flex-col items-start">
            <span className="text-[#202124] text-base font-semibold">{displayName}</span>
        ...
        <DropdownMenuGroup>
          ...
          >
            <UserIcon className="text-[#202124] size-5 mr-3" />
            <span className="text-[#202124] font-semibold">User Area</span>
          </DropdownMenuItem>
          <DropdownMenuItem
            className="px-4 py-2.5 text-base cursor-pointer"
          ...
          >
            <UserIcon className="text-[#202124] size-5 mr-3" />
            <span className="text-[#202124]">Your Profile</span>
          </DropdownMenuItem>
          <DropdownMenuItem
            className="px-4 py-2.5 text-base cursor-pointer"
            onClick={() => (window.location.href = '/dashboard/profile/edit')}
          >
            <SettingsIcon className="text-[#202124] size-5 mr-3" />
            <span className="text-[#202124]">Settings</span>
          </DropdownMenuItem>
        </DropdownMenuGroup>
