import { e as createComponent, f as createAstro, m as maybeRenderHead, h as addAttribute, k as renderComponent, r as renderTemplate } from '../chunks/astro/server_DxclfMW8.mjs';
import 'piccolore';
...
function CreateContentModal({ currentUser, userInitials, activeFeed = "post" }) {
  ...
  const getButtonClass = (feedType) => {
    ...
    return `flex items-center gap-2 py-2 px-3 rounded text-sm font-semibold transition-all duration-200 ${isActive ? "bg-primary-500/10 text-primary-400 border border-primary-500/20 shadow-[0_0_15px_rgba(var(--color-primary-500),0.1)]" : "text-[var(--text-secondary)] hover:bg-[var(--bg-surface-hover)] hover:text-[var(--text-main)] border border-transparent"}`;
  };
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "bg-[var(--bg-surface)] rounded-lg border border-[var(--border-color)] p-4 mb-6", children: [
      /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-full bg-[var(--bg-surface-hover)] flex-shrink-0 flex items-center justify-center border border-[var(--border-color)] group-hover:border-primary-500/50 transition-colors text-[var(--text-main)] font-bold", children: userInitials }),
            /* @__PURE__ */ jsx("div", { className: "w-full bg-[var(--bg-body)] border border-[var(--border-color)] rounded-full px-6 py-3 text-sm text-[var(--text-secondary)] group-hover:border-primary-500/50 group-hover:text-[var(--text-main)] transition-all flex items-center shadow-inner", children: "Start a post, share a mining update..." })
          ]
        }
      ),
...
const $$Feed = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let error = null;
  if (feedType === "post") {
    const { data: posts, error: err } = await supabase.from("posts").select(`*, author:profiles(full_name, avatar_url, profession, company), topic:topics(name, slug)`).order("created_at", { ascending: false }).limit(20);
    data = posts || [];
    error = err;
  ...
  return renderTemplate`${maybeRenderHead()}<div class="max-w-3xl mx-auto pb-20"> <!-- Header / Creator --> ${Astro2.locals.user && renderTemplate`${renderComponent($$result, "CreateContentModal", CreateContentModal, { "client:load": true, "currentUser": Astro2.locals.user, "userInitials": Astro2.locals.user.email?.charAt(0).toUpperCase() || "U", "activeFeed": feedType, "client:component-hydration": "load", "client:component-path": "D:/zvenia/astro-frontend/src/components/dashboard/CreateContentModal", "client:component-export": "default" })}`} <!-- Feed Label --> <div class="flex justify-between items-center px-4 mb-4"> <h3 class="text-white font-bold text-lg capitalize flex items-center gap-2"> ${feedType === "post" && renderTemplate`<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-primary-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><line x1="10" y1="9" x2="8" y2="9"></line></svg>`} ${feedType === "event" && renderTemplate`<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-primary-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>`} ${feedType === "podcast" && renderTemplate`<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-primary-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"></path><path d="M19 10v2a7 7 0 0 1-14 0v-2"></path><line x1="12" y1="19" x2="12" y2="23"></line><line x1="8" y1="23" x2="16" y2="23"></line></svg>`} ${feedType === "service" && renderTemplate`<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-primary-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path></svg>`} ${feedType === "post" && "Latest Posts"} ${feedType === "event" && "Upcoming Events"} ${feedType === "podcast" && "Recent Podcasts"} ${feedType === "service" && "Professional Services"} </h3> <span class="text-xs text-gray-500">Sorted by: <span class="font-bold text-white">Newest</span></span> </div> <!-- Empty State --> ${data.length === 0 && renderTemplate`<div class="text-center py-16 bg-[#1A1A1A] rounded-lg border border-white/10 mx-4"> <div class="mb-4 opacity-20 flex justify-center"> ${feedType === "post" && renderTemplate`<svg xmlns="http://www.w3.org/2000/svg" class="w-16 h-16 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><line x1="10" y1="9" x2="8" y2="9"></line></svg>`} ${feedType === "event" && renderTemplate`<svg xmlns="http://www.w3.org/2000/svg" class="w-16 h-16 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>`} ${feedType === "podcast" && renderTemplate`<svg xmlns="http://www.w3.org/2000/svg" class="w-16 h-16 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"></path><path d="M19 10v2a7 7 0 0 1-14 0v-2"></path><line x1="12" y1="19" x2="12" y2="23"></line><line x1="8" y1="23" x2="16" y2="23"></line></svg>`} ${feedType === "service" && renderTemplate`<svg xmlns="http://www.w3.org/2000/svg" class="w-16 h-16 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path></svg>`} </div> <h3 class="text-xl font-bold text-white mb-2">No ${feedType}s found</h3> <p class="text-gray-400 text-sm">Be the first to create one!</p> </div>`} <!-- FEED RENDERER --> <div${addAttribute(feedType === "event" || feedType === "service" ? "grid grid-cols-1 md:grid-cols-2 gap-4 px-2" : "space-y-4 px-2", "class")}>  ${feedType === "post" && data.map((item) => renderTemplate`${renderComponent($$result, "PostCard", $$PostCard, { "post": item, "currentUser": Astro2.locals.user })}`)}  ${feedType === "event" && data.map((item) => renderTemplate`${renderComponent($$result, "EventCard", EventCard, { "client:load": true, "event": item, "currentUser": Astro2.locals.user, "client:component-hydration": "load", "client:component-path": "D:/zvenia/astro-frontend/src/components/social/EventCard", "client:component-export": "default" })}`)}  ${feedType === "podcast" && data.map((item) => renderTemplate`${renderComponent($$result, "PodcastRow", PodcastRow, { "client:load": true, "podcast": item, "currentUser": Astro2.locals.user, "client:component-hydration": "load", "client:component-path": "D:/zvenia/astro-frontend/src/components/social/PodcastRow", "client:component-export": "default" })}`)}  ${feedType === "service" && data.map((item) => renderTemplate`${renderComponent($$result, "ServiceCard", ServiceCard, { "client:load": true, "service": item, "currentUser": Astro2.locals.user, "client:component-hydration": "load", "client:component-path": "D:/zvenia/astro-frontend/src/components/social/ServiceCard", "client:component-export": "default" })}`)} </div> </div>`;
}, "D:/zvenia/astro-frontend/src/components/social/Feed.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "SocialLayout", $$SocialLayout, { "title": "Zvenia - The Community for Mining Professionals" }, { "default": ($$result2) => renderTemplate`   ${renderComponent($$result2, "Feed", $$Feed, {})}  `, "left-sidebar": ($$result2) => renderTemplate`${renderComponent($$result2, "LeftSidebar", $$LeftSidebar, { "slot": "left-sidebar" })}`, "right-sidebar": ($$result2) => renderTemplate`${renderComponent($$result2, "RightSidebar", $$RightSidebar, { "slot": "right-sidebar" })}` })}`;
}, "D:/zvenia/astro-frontend/src/pages/index.astro", void 0);

const $$file = "D:/zvenia/astro-frontend/src/pages/index.astro";
const $$url = "";
