import { e as createComponent, k as renderComponent, o as renderScript, r as renderTemplate, m as maybeRenderHead } from '../chunks/astro/server_DxclfMW8.mjs';
import 'piccolore';
import { $ as $$Layout } from '../chunks/Layout_7SPMbouh.mjs';
import { $ as $$ThemeToggle, a as $$MiningBackground } from '../chunks/MiningBackground_DUsiKnvp.mjs';
...
Don't have an account? <a href="/join" class="font-bold text-primary-500 hover:text-primary-400 hover:underline">Sign up for Zvenia</a> </p> </div> </div> </div> </div> ` })} ${renderScript($$result, "D:/zvenia/astro-frontend/src/pages/login.astro?astro&type=script&index=0&lang.ts")}`;
}, "D:/zvenia/astro-frontend/src/pages/login.astro", void 0);

const $$file = "D:/zvenia/astro-frontend/src/pages/login.astro";
const $$url = "/login";
